            ...
            <div className="relative w-full h-[600px]">
                ...
                {platforms.map((platform, index) => (
                    <div
                        ...
                        className={`absolute ${platform.size} shadow-lg rounded-lg p-4 flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer overflow-hidden`}
                    >
                        <img
                            src={platform.logo}
                            alt={platform.name}
